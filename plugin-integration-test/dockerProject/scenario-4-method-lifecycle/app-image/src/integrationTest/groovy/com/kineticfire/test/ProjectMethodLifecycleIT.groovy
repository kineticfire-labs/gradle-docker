...
/**
 * Integration Test: dockerProject Scenario 4 - Method Lifecycle Mode
 *
 * This test demonstrates the simplified dockerProject DSL with 'method' lifecycle mode
 ...
 *
 * The dockerProject configuration with lifecycle.set('method'):
 * 1. Translates to dockerWorkflows pipeline with lifecycle=METHOD
 * 2. Sets system properties (docker.compose.lifecycle, docker.compose.files, etc.)
 ...
 */
@ComposeUp  // Reads system properties set by the pipeline's METHOD lifecycle
@Stepwise
class ProjectMethodLifecycleIT extends Specification {
    ...
    def setupSpec() {
        ...
        RestAssured.port = 9303

        println "=== dockerProject Integration Test: Method Lifecycle ==="
