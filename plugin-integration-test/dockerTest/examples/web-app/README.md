...
**Use Case**: REST API testing with dockerTest plugin

## Purpose

Demonstrates how to test a Spring Boot REST API using the dockerTest plugin with **Spock** test framework extension for CLASS lifecycle.
...
**✅ Recommended**:
1. Configure stack in `build.gradle` → `dockerTest.composeStacks { }`
