...
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:lifecycle-method:app-image:runIntegrationTest

# Individual steps
./gradlew -Pplugin_version=1.0.0-SNAPSHOT dockerTest:verification:lifecycle-method:app:bootJar
./gradlew -Pplugin_version=1.0.0-SNAPSHOT dockerTest:verification:lifecycle-method:app-image:dockerBuildStateApp
./gradlew -Pplugin_version=1.0.0-SNAPSHOT dockerTest:verification:lifecycle-method:app-image:composeUpLifecycleMethodTest
./gradlew -Pplugin_version=1.0.0-SNAPSHOT dockerTest:verification:lifecycle-method:app-image:integrationTest
./gradlew -Pplugin_version=1.0.0-SNAPSHOT dockerTest:verification:lifecycle-method:app-image:composeDownLifecycleMethodTest
```
