...
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:wait-healthy:app-image:runIntegrationTest
```
...
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:wait-healthy:clean

# Build the app
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:wait-healthy:app:bootJar

# Build Docker image
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:wait-healthy:app-image:dockerBuildWaitHealthyApp

# Start Docker Compose stack
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:wait-healthy:app-image:composeUpWaitHealthyTest

# Run tests (requires stack to be up)
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:wait-healthy:app-image:integrationTest

# Stop Docker Compose stack
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:wait-healthy:app-image:composeDownWaitHealthyTest
```
...
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:wait-healthy:clean \
  dockerTest:verification:wait-healthy:app:clean \
  dockerTest:verification:wait-healthy:app-image:clean
```
