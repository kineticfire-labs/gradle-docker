...
These tests validate the dockerTest plugin's internal mechanics. They are **NOT** examples of how users should write
tests.
...
./gradlew dockerTest:verification:integrationTest

# Run specific verification scenario
./gradlew dockerTest:verification:basic:integrationTest
./gradlew dockerTest:verification:wait-healthy:integrationTest
```
