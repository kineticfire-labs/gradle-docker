...
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:mixed-wait:app-image:runIntegrationTest
```
...
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:mixed-wait:clean

# Build the app
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:mixed-wait:app:bootJar

# Build Docker image
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:mixed-wait:app-image:dockerBuildMixedWaitApp

# Start Docker Compose stack (BOTH services)
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:mixed-wait:app-image:composeUpMixedWaitTest

# Run tests (requires stack to be up)
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:mixed-wait:app-image:integrationTest

# Stop Docker Compose stack (BOTH services)
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:mixed-wait:app-image:composeDownMixedWaitTest
```
...
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:mixed-wait:clean \
  dockerTest:verification:mixed-wait:app:clean \
  dockerTest:verification:mixed-wait:app-image:clean
```
