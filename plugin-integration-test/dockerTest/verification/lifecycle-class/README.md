...
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerTest:verification:lifecycle-class:app-image:runIntegrationTest

# Individual steps
./gradlew -Pplugin_version=1.0.0-SNAPSHOT dockerTest:verification:lifecycle-class:app:bootJar
./gradlew -Pplugin_version=1.0.0-SNAPSHOT dockerTest:verification:lifecycle-class:app-image:dockerBuildStateApp
./gradlew -Pplugin_version=1.0.0-SNAPSHOT dockerTest:verification:lifecycle-class:app-image:composeUpLifecycleClassTest
./gradlew -Pplugin_version=1.0.0-SNAPSHOT dockerTest:verification:lifecycle-class:app-image:integrationTest
./gradlew -Pplugin_version=1.0.0-SNAPSHOT dockerTest:verification:lifecycle-class:app-image:composeDownLifecycleClassTest
```
