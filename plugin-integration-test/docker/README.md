...
|---|--------------------------------------------------------|--------------------------------------------------------------------|
| 2 | number of images = 1                                   | <ol><li>scenario-1</li><li>scenario-2</li><li>scenario-3</li></ol> |
| 2 | number of images > 1                                   | todo                                                               |
| 2 | build image only                                       | <ol><li>scenario-1</li></ol>                                       |
| 2 | build image + follow-on save and/or publish            | <ol><li>scenario-2</li><li>scenario-3</li></ol>                    |
...
| 3 | number of labels = none                                | <ol><li>scenario-3</li></ol>                                       |
...
| # | Tested Feature     | Test Scenario                                   | 
|---|--------------------|-------------------------------------------------|
| 1 | number of tags = 1 | <ol><li>scenario-2</li><li>scenario-3</li></ol> |
...
| 7  | publish to private registry without authentication                  | <ol><li>scenario-2</li><li>scenario-3</li></ol> |
