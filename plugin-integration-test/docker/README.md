...
|---|--------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| 1 | number of images = 1                                   | <ol><li>scenario-1</li><li>scenario-2</li><li>scenario-3</li><li>scenario-4</li><li>scenario-6</li><li>scenario-7</li><li>scenario-99</li></ol> |
...
| 2 | Image Name Mode: imageName, tag(s)                     | <ol><li>scenario-1</li><li>scenario-7</li><li>scenario-99</li></ol>                                                                             |
...
| 8  | publish to private registry w/ authentication                       | <ol><li>scenario-6</li><li>scenario-11</li><li>scenario-12</li></ol>                                                                           |
| 9  | publish to public registry: Docker Hub                              | <ol><li>scenario-99</li></ol>                                                                                                                  |
...
| 16 | inherit sourceRef: namespace, imageName                             | <ol><li>scenario-5</li></ol>                                                                                                                   |
| 17 | Image Name Mode: registry, namespace, imageName, tag(s)             | <ol><li>scenario-11</li></ol>                                                                                                                  |
| 18 | Image Name Mode: namespace, imageName, 2 tags                       | <ol><li>scenario-3</li></ol>                                                                                                                   |
| 19 | Image Name Mode: registry, (inherit namespace), imageName, tag(s)   | <ol><li>scenario-2</li></ol>                                                                                                                   |
| 20 | Repository Mode: registry, repository, 2 tags                       | <ol><li>scenario-6</li><li>scenario-8</li></ol>                                                                                                |
| 21 | Repository Mode: repository, 1 tag                                  | <ol><li>scenario-12</li></ol>                                                                                                                  |
