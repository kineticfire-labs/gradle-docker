...
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:wait-running:app-image:runIntegrationTest
```
...
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:wait-running:clean

# Build the app
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:wait-running:app:bootJar

# Build Docker image
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:wait-running:app-image:dockerBuildWaitRunningApp

# Start Docker Compose stack
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:wait-running:app-image:composeUpWaitRunningTest

# Run tests (requires stack to be up)
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:wait-running:app-image:integrationTest

# Stop Docker Compose stack
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:wait-running:app-image:composeDownWaitRunningTest
```
...
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:wait-running:clean \
  dockerOrch:verification:wait-running:app:clean \
  dockerOrch:verification:wait-running:app-image:clean
```
