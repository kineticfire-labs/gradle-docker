...
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:basic:app-image:runIntegrationTest
```
...
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:basic:clean

# Build the app
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:basic:app:bootJar

# Build Docker image
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:basic:app-image:dockerBuildWebApp

# Start Docker Compose stack
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:basic:app-image:composeUpWebAppTest

# Run tests (requires stack to be up)
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:basic:app-image:integrationTest

# Stop Docker Compose stack
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:basic:app-image:composeDownWebAppTest
```
...
./gradlew -Pplugin_version=1.0.0-SNAPSHOT \
  dockerOrch:verification:basic:clean \
  dockerOrch:verification:basic:app:clean \
  dockerOrch:verification:basic:app-image:clean
```
